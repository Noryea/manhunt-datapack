...
execute store result score 0= gu.main store result score 1= gu.main run data get entity @s UUID[0]
...
execute store result score 0= gu.main store result score 1= gu.main run data get entity @s UUID[1]
...
execute store result score 0= gu.main store result score 1= gu.main run data get entity @s UUID[2]
