...
execute if score 队友追踪器:显示维度 mh.settings matches 1 unless data storage mh:temp actionBarExtra[0].extra[1].translate run data modify storage mh:temp actionBarExtra[0].extra[1].text set from storage mh:temp trackerData.info.exactDimension
