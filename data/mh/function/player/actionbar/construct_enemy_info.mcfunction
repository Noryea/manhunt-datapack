...
execute if score 敌人追踪器:显示维度 mh.settings matches 1 run data modify storage mh:temp actionBarExtra prepend value {text:"",extra:[{text:"维度:",color:"white"},{text:""}]}
...
execute unless score 敌人追踪器:显示XZ坐标 mh.settings matches 1 if score 敌人追踪器:显示Y坐标 mh.settings matches 1 run data modify storage mh:temp actionBarExtra prepend value {text:"",extra:[{text:"Y=",color:"white"},{nbt:"LodestoneTargetCopy.pos[1]",storage:"mh:temp",color:"gold"}]}
execute if score 敌人追踪器:显示XZ坐标 mh.settings matches 1 unless score 敌人追踪器:显示Y坐标 mh.settings matches 1 run data modify storage mh:temp actionBarExtra prepend value {text:"",extra:[{text:"XZ=",color:"white"},{nbt:"LodestoneTargetCopy.pos[0]",storage:"mh:temp",color:"gold"},{text:",",color:"gray"},{nbt:"LodestoneTargetCopy.pos[2]",storage:"mh:temp",color:"gold"}]}
