...
execute unless score #ret mh.temp matches 0 run function mh:compass/select/writedown with entity @s equipment.offhand.components."minecraft:writable_book_content".pages[0]
