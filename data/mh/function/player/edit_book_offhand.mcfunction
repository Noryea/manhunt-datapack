...
execute unless score #flag mh.temp matches 0 run function mh:compass/select/writedown with entity @s Inventory[{Slot:-106b}].components."minecraft:writable_book_content".pages[0]
