...
item modify entity @s weapon.mainhand [{function:"set_components",components:{"!minecraft:writable_book_content":{}}},{function:"set_name",name:{"text":"追踪器","color":"white","italic": false}},{function: "set_item", item: "compass"},{function: "set_components", components: {"!minecraft:lore":{},"minecraft:max_stack_size": 1}}]
