...
# 玩家可能丢出ui物品
execute if score #result mh.temp matches 0 store result score #ui_item_count mh.temp run data get entity @e[type=item,limit=1,sort=nearest,distance=..5,nbt={Item:{components:{"minecraft:custom_data":{"mhUI":true}}}}] Item.count
