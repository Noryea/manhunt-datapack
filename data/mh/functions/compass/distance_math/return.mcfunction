...
execute store result entity @s Attributes[0].Base double -0.001 run scoreboard players get self_x mh.temp
...
scoreboard players remove vec_x mh.temp 1000
execute store result storage mh:temp AttributeModifiers[0].Amount double 0.001 run scoreboard players get vec_x mh.temp
# 应用属性修饰器
...
execute store result entity @s Attributes[0].Base double -0.001 run scoreboard players get self_y mh.temp
data modify storage mh:temp AttributeModifiers[1].Amount set from entity 0-0-0-0-0ea Pos[1]
scoreboard players remove vec_y mh.temp 1000
execute store result storage mh:temp AttributeModifiers[0].Amount double 0.001 run scoreboard players get vec_y mh.temp
# 应用属性修饰器
data modify entity @s Attributes[0].Modifiers set from storage mh:temp AttributeModifiers
...
execute store result entity @s Attributes[0].Base double -0.001 run scoreboard players get self_z mh.temp
data modify storage mh:temp AttributeModifiers[1].Amount set from entity 0-0-0-0-0ea Pos[2]
scoreboard players remove vec_z mh.temp 1000
execute store result storage mh:temp AttributeModifiers[0].Amount double 0.001 run scoreboard players get vec_z mh.temp
# 应用属性修饰器
data modify entity @s Attributes[0].Modifiers set from storage mh:temp AttributeModifiers
