...
tellraw @a ["\u00a77[",{"selector":"@s"},"\u00a77] ",{"text":"已清空所有玩家的状态","color":"white","hoverEvent": {"action": "show_text","value":"重置所有玩家的血量、背包、重生点、进度和配方"},"clickEvent": {"action": "suggest_command","value": "/function mh:settings/menu/click_events/recover_players"}}]
