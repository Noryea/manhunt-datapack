...
# 1.20.5快照版本
data modify storage mh:temp TextBuffer set from entity @s SelectedItem.components."minecraft:writable_book_content".pages[0].text
# 1.20.5正式版本
...
item replace entity @s weapon.mainhand with compass 1
