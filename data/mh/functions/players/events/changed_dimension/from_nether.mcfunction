...
execute if data entity @s {Dimension:"minecraft:overworld"} as @a unless score @s mh.pos.x.0 matches -2147483648..2147483647 store result score @s mh.pos.x.0 run data get entity @p[tag=self] Pos[0] 1
execute if data entity @s {Dimension:"minecraft:overworld"} as @a unless score @s mh.pos.y.0 matches -2147483648..2147483647 store result score @s mh.pos.y.0 run data get entity @p[tag=self] Pos[1] 1
execute if data entity @s {Dimension:"minecraft:overworld"} as @a unless score @s mh.pos.z.0 matches -2147483648..2147483647 store result score @s mh.pos.z.0 run data get entity @p[tag=self] Pos[2] 1
...
execute if data entity @s {Dimension:"minecraft:overworld"} store result score @s mh.pos.x.0 run data get entity @p[tag=self] Pos[0] 1
execute if data entity @s {Dimension:"minecraft:overworld"} store result score @s mh.pos.y.0 run data get entity @p[tag=self] Pos[1] 1
execute if data entity @s {Dimension:"minecraft:overworld"} store result score @s mh.pos.z.0 run data get entity @p[tag=self] Pos[2] 1
