...
#返回现在维度自己来的位置
execute if data entity @s {Dimension:"minecraft:the_end"} run scoreboard players operation @s mh.pos.x.1 = @s mh.pos.x
execute if data entity @s {Dimension:"minecraft:the_end"} run scoreboard players operation @s mh.pos.y.1 = @s mh.pos.y
execute if data entity @s {Dimension:"minecraft:the_end"} run scoreboard players operation @s mh.pos.z.1 = @s mh.pos.z
...
execute if data entity @s {Dimension:"minecraft:the_end"} as @a unless score @s mh.pos.x.1 matches -2147483648..2147483647 run scoreboard players operation @s mh.pos.x.1 = @p[tag=self] mh.pos.x
execute if data entity @s {Dimension:"minecraft:the_end"} as @a unless score @s mh.pos.y.1 matches -2147483648..2147483647 run scoreboard players operation @s mh.pos.y.1 = @p[tag=self] mh.pos.y
execute if data entity @s {Dimension:"minecraft:the_end"} as @a unless score @s mh.pos.z.1 matches -2147483648..2147483647 run scoreboard players operation @s mh.pos.z.1 = @p[tag=self] mh.pos.z
